...
const stations: Station[] = [
  ...
  },
  {
    ...
    description:
      'Armá el rompecabezas y descubrí qué animal aparece cuando completás la imagen.',
    audio: '/audio/fauna2.mp3',
  },
  {
    id: 'universo',
